namespace sample_5_6.DashboardControls {
  partial class RoomBookingsCurrentYear {
    ...
    private void InitializeComponent() {
      ...
      this.roomBookingsCurrentYearGauge = new DevExpress.XtraGauges.Win.Gauges.Circular.CircularGauge();
      this.arcScaleComponent1 = new DevExpress.XtraGauges.Win.Gauges.Circular.ArcScaleComponent();
      this.arcScaleBackgroundLayerComponent1 = new DevExpress.XtraGauges.Win.Gauges.Circular.ArcScaleBackgroundLayerComponent();
      this.arcScaleNeedleComponent1 = new DevExpress.XtraGauges.Win.Gauges.Circular.ArcScaleNeedleComponent();
      ((System.ComponentModel.ISupportInitialize)(this.roomBookingsCurrentYearGauge)).BeginInit();
      ...
      this.gaugeControl1.Gauges.AddRange(new DevExpress.XtraGauges.Base.IGauge[] {
            this.roomBookingsCurrentYearGauge});
      this.gaugeControl1.Location = new System.Drawing.Point(0, 0);
      this.gaugeControl1.Name = "gaugeControl1";
      this.gaugeControl1.Size = new System.Drawing.Size(466, 290);
      this.gaugeControl1.TabIndex = 0;
      // 
      // roomBookingsCurrentYearGauge
      // 
      this.roomBookingsCurrentYearGauge.BackgroundLayers.AddRange(new DevExpress.XtraGauges.Win.Gauges.Circular.ArcScaleBackgroundLayerComponent[] {
            this.arcScaleBackgroundLayerComponent1});
      this.roomBookingsCurrentYearGauge.Bounds = new System.Drawing.Rectangle(6, 6, 454, 278);
      this.roomBookingsCurrentYearGauge.Name = "roomBookingsCurrentYearGauge";
      this.roomBookingsCurrentYearGauge.Needles.AddRange(new DevExpress.XtraGauges.Win.Gauges.Circular.ArcScaleNeedleComponent[] {
            this.arcScaleNeedleComponent1});
      this.roomBookingsCurrentYearGauge.Scales.AddRange(new DevExpress.XtraGauges.Win.Gauges.Circular.ArcScaleComponent[] {
      ...
      ((System.ComponentModel.ISupportInitialize)(this.roomBookingsCurrentYearGauge)).EndInit();
    ...
    private DevExpress.XtraGauges.Win.Gauges.Circular.CircularGauge roomBookingsCurrentYearGauge;
